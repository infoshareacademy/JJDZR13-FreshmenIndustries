...
import pl.isa.freshmenindustries.auth.UserRegisterDTO;
...
public class UserController {
    ...
    public String createUser(@ModelAttribute UserRegisterDTO userRegisterDto, RedirectAttributes redirectAttributes) {
